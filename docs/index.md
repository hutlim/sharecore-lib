...
* [Peer to Peer Networking](https://github.com/hutlim/sharecore-p2p)
...
var imported = sharecore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new sharecore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new sharecore.URI(paymentInfo).toString();
```
